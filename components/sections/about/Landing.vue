    ...
    <section class="bg-white flex flex-col-reverse md:flex-row justify-around gap-8 md:gap-0 p-4">
        <div class="animation-element fade-left w-full md:w-1/2 flex flex-col justify-center gap-8 ">
            ...
            <p>
                ...
                Yüzüncü Yıl Üniversitesi Periodontoloji Bölümü’nde devam etti. İstanbul üniversitesinde Diş eti Tedavisi
                ve İmplant Cerrahisi Uzmanı unvanı aldı. Etilerde kendi özel kliniğinde Estetik Diş Hekimliği ve İmplant
                cerrahisi alanında uzman olarak çalışmaktadır.
            </p>
        </div>
