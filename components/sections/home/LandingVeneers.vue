...
<template>
    <div class="flex flex-col bg-blue-50 ">
        <div class="w-full bg-blue-100  text-center py-8">
            <div class="w-full text-white bg-blue-300 shadow-md p-8">
                <h1 data-aos="fade-up" class="text-lg">Uzm. Dr. Deniz Yılmaz Diş Kliniği</h1>
                <h2 data-aos="fade-up" class="text-sm">Kültür mahallesi Ahmet Adnan Saygun Caddesi No:3 Akmerkez Residence Daire:7B1, 34337
                    Beşiktaş/İstanbul</h2>
            </div>
        </div>
        <div class="w-full flex flex-col items-center justify-around md:flex-row p-4 md:p-14">
            <nuxt-img data-aos="fade-right" class="object-contain w-2/3 md:w-5/12 rounded-xl shadow-lg" src="/veneers.png" />
            <div class="w-full md:w-1/2 flex flex-col gap-10 justify-around p-2 py-8 sm:p-8 md:p-4 ">
                <h1 data-aos="fade-left" class="text-6xl">Dental Veneers</h1>
                <h2 data-aos="fade-left" class="text-4xl text-gray-800">Daha
                    <span class="text-blue-400">{{ current }}|</span>
                </h2>
                <span data-aos="fade-left">Veneers hakkında teknik olmayan kısa bir açıklama. Lorem ipsum dolor sit amet consectetur
